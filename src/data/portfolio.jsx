...
export const homeConfig = {
    ...
    about: {
        start: "I am an IIT Delhi alumnus with over two years of experience in AI and data science, currently working as an AI Engineer at KPMG. I am driven by the challenge of building innovative solutions and harnessing the power of data to create real-world impact.",
    ...
    workTimeline: [
        {
            ...
            title: "AI Engineer",
            company: "KPMG",
            description: "Developing next-generation conversational AI solutions for Indian government platforms, harnessing agentic AI to make public services more accessible, efficient, and impactful for millions of citizens.",
            date: "2025-present",
            icon: Bot,
            tags: ["generative-ai", "llm", "rag", "python", "pytorch", "langchain", "nlp", "agentic-ai"],
        },
        {
            id: "work-1",
            title: "Senior Analyst",
            company: "Paisabazaar",
            description: "Developed and deployed machine learning models for credit risk and fraud detection.",
            date: "2024-2025",
            icon: CreditCard,
            tags: ["ml", "hive", "python", "scikit", "pandas", "sql", "credit-risk", "llm", "rag"],
        },
        {
            id: "work-0",
            title: "Junior Data Scientist",
            company: "Nuvoretail Enlytical",
            description: "Automated and optimized bidding process for AMS. Build models, microservices, and dashboards.",
            date: "2023-2024",
            icon: LineChart,
